...
function usage() {
  ...
  diagram-to-image list-agents [--scope global|project]
  diagram-to-image status [--scope global|project]
...
Scopes:
  global   Install to ~/.codex/skills/ or ~/.claude/skills/ (default)
  project  Install to ./.codex/skills/ or ./.claude/skills/ in current directory
`;
}
...
async function run(argv, {
  ...
  if (argv.length === 0) {
    ...
    // Non-interactive: default to all agents, global scope
